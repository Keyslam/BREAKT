...
public class LevelInspector : LevelBase {
...
"00000cccccc000000"
	...
	public override List<BlockBase> GetLevel(Humper.World world) {
		...
		for (int y = 0; y < lines.Length; y++) {
			...
			for (int x = 0; x < line.Length; x++) {
				...
				switch (line[x]) {
					case 'C':
						block = new BlockIndestructible(world, new Vector2(8 + x * 52, 8 + y * 52), BlockIndestructible.black);
						break;
					case 'c':
	...
	private static Image image = Graphics.NewImage("Assets/Levels/Inspector.png");
